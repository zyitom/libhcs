...
/* libhcs LOCAL PATCH: libhcs device identity instead of the WCH CH372 demo's
 * (0x1A86:0x5537). VID 0xA511 is the libhcs vendor id shared by every board;
 * 0xD403 is the ch32_board type PID (c_board 0xF407, mc02 0x0723). The host SDK
 * matches on this pair plus the iProduct string. */
#define DEF_USB_VID                  0xA511
 ...
 * descriptors are built at runtime by libhcs_usb_init_descriptors()
...
extern void libhcs_usb_init_descriptors( void );
